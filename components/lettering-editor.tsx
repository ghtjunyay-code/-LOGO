...
export default function LetteringEditor({spot:s,update}:{spot:Spot;update:(fn:(s:Spot)=>void)=>void}){
 ...
 {v.items.map(t=>{const fontText=t.personal?personalText(t.personal):t.text;const c=threadColors.find(c=>c.number===t.thread)!;return <div className="lettering-item" key={t.role}>
