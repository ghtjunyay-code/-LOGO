...
const kinds=['半袖Tシャツ','ノースリーブ','半袖ポロシャツ','半袖シャツ','長袖Tシャツ','ラグラン','長袖ポロシャツ','パーカー','トレーナー','スウェット','ジャージ','エプロン','作業服（長袖ブルゾン）','作業服（半袖ブルゾン）','作業服（長袖シャツ）','作業服（半袖シャツ）','つなぎ服','ウィンドブレーカー（ヤッケ）','イベントブルゾン','イベントベスト','防寒着'];
