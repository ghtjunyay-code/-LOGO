...
export type LetteringItem={personal?:PersonalNames;direction?:Direction;role:'会社名'|'個人名';text:string;font:string;size:number;thread:string;position:string;gap:number;angle:number};
